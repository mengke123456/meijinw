...
class ManagerSearch extends Managertbl
{
    ...
    public function search($params)
    {
        ...
        // // //增加排序规则部门
        //  $query->join('INNER JOIN','DepartmentTypetbl','Managertbl.department = DepartmentTypetbl.id');
        // $query->andFilterWhere(['like','DepartmentTypetbl.department_type',$this->department_type]);
        
        //  $dataProvider->sort->attributes['department_type'] = 
        //  [
        //     'asc'=>['DepartmentTypetbl.department_type'=>SORT_ASC],
        //     'desc'=>['DepartmentTypetbl.department_type'=>SORT_DESC],
        //  ]; 
